...
const RenderCards = ({ posts, emptyStateMessage }: RenderCardsProps) => {
  ...
  return (
    <h2 className="mt-5 font-bold text-slate-600 dark:text-slate-300 text-xl uppercase">
      {emptyStateMessage}
    </h2>
  );
};
        ...
        {loading ? (
          ...
          <>
            {debouncedSearchQuery && (
              <h2 className="font-medium text-slate-600 dark:text-slate-400 text-xl mb-3">
                Showing results for{" "}
